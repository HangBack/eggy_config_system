...
local ConfigType = require "game.enums.ConfigType"
...
---@field enum_field string 枚举类型（原始文本）
---@field text_field string 普通文本
---@field number_field integer 数值字段
---@field datalist_field string 数据列表（原始文本）
...
local result = {
    ["示例配置1"] = {
        ...
        enum_field = ConfigType.Normal, -- 枚举类型（原始文本）
        text_field = "这是普通文本", -- 普通文本
        number_field = 100, -- 数值字段
        datalist_field = AreaCode.Ocean, -- 数据列表（原始文本）
        entry_list = {
    ...
    ["示例配置2"] = {
        ...
        enum_field = ConfigType.Special, -- 枚举类型（原始文本）
        text_field = "特殊配置", -- 普通文本
        number_field = 200, -- 数值字段
        datalist_field = AreaCode.River, -- 数据列表（原始文本）
        entry_list = {
    ...
    ["示例配置3"] = {
        ...
        enum_field = ConfigType.Rare, -- 枚举类型（原始文本）
        text_field = "稀有配置", -- 普通文本
        number_field = 500, -- 数值字段
        datalist_field = AreaCode.Lake, -- 数据列表（原始文本）
        entry_list = {
        } -- 条目列表
    }
}
